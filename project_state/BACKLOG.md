...
| 6 | M2A | BIDS-curated EEG/MEG oddball intake slice | Phase 2 | in progress | M1D | Start EEG/MEG expansion only after the Phase 1 behavioral slice is narrow, credible, and complete. |
| 7 | M2B | EEG/MEG preprocessing, QC, and report integration | Phase 2 | planned | M2A | Extend the neuro slice after BIDS intake exists and can feed reproducible QC/report outputs. |
